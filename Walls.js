document.write("<html>");
document.write("<head>");
document.write("<script src=\"WallSlice.js\"><\/script>");
document.write("<\/head>");
document.write("<\/html>");
...
Walls.VIEWPORT_NUM_SLICES = Math.ceil(Walls.VIEWPORT_WIDTH/WIDTH) + 1;

Walls.prototype.setViewportX = function(viewportX) {
  this.viewportX = this.checkViewportXBounds(viewportX);

  var prevViewportSliceX = this.viewportSliceX;
  this.viewportSliceX = Math.floor(this.viewportX/WIDTH);
